...
namespace Taller_Negocio
{
    ...
    public class Empleado_Negocio
    {
        ...
        /// <returns></returns>
        public bool crearEmpleado(string id_emp, string rut_empleado, string dv_empleado, string p_nombre_empleado, string s_nombre_empleado, string p_apellido_empleado,
            ...
            string nombre_usu_empleado, string contrasena_empleado, string id_comuna, string id_taller, string id_cargo)
        {
            ...
            try
            {
                ...
                Parameters.Add("v_contrasena_empleado", compartido.Encriptar(contrasena_empleado));
